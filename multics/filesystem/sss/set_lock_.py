...
class set_lock_(SystemExecutable):
    ...
    def lock(self, segment_data_ptr, wait_time, code):
        ...
        file_locks = process.stack.file_locks
        lock_id = segment_data_ptr._filepath()
        ...
        try:
            ...
            if not os.path.exists(segment_data_ptr._filepath()):
...
class FileLock(object):
    ...
    def __init__(self, segment_data_ptr, process_id, timeout, process_id_list):
        ...
        """
        dirname, filename = os.path.split(segment_data_ptr._filepath())
