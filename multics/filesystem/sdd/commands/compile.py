...
def compile():
    ...
    dir_name = call.sys_.get_current_directory()
    call.ioa_("Compiling {0} to {1} in {2}", file_name, out_file_name, dir_name)
    try:
        call.hcs_.make_path(dir_name, file_name, source_file)
        call.hcs_.make_path(dir_name, out_file_name, object_file)
