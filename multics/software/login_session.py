...
class LoginSession(QtCore.QObject):
    ...
    def __init__(self, system_services, login_session_manager, cp_path, pit):
        ...
        # self.__user_id = pit.user_id
        self.__homedir = None
        self.__process = None
        self.__cp_path = cp_path
        self.__pit = pit
        pit.time_login = self.__session_datetime
    ...
    def start(self):
        self.__system_services.llout("\n%s logged in on %s\n" % (self.__pit.user_id, self.__session_datetime.ctime()))
    ...
    def _main_loop(self):
        ...
        while code != System.LOGOUT and code != System.SHUTDOWN:
            ...
            if command.processor == null():
                ...
                self.__process = VirtualMulticsProcess(self.__system_services, self, command.processor, self.__pit)
